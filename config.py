...
DATABASE_URL = os.environ.get("DATABASE_URL", "postgres://ghsvngty:7YFyqpQRwMl6GZq6X1j41BdG35sm45Sh@arjuna.db.elephantsql.com/ghsvngty")

RESTRICT = strtobool(os.environ.get("RESTRICT", "True"))

FORCE_SUB_1 = int(os.environ.get("FORCE_SUB_1", "-1002091907347"))
FORCE_SUB_2 = int(os.environ.get("FORCE_SUB_2", "-1001914204388"))
